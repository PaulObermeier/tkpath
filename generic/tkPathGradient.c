...
static Tk_OptionSpec linGradientStyleOptionSpecs[] = {
    {TK_OPTION_STRING_TABLE, "-method", NULL, NULL,
        "pad", -1, offsetof(TkPathGradientMaster, linearFill.method),
        0, (ClientData) methodST, 0},
    {TK_OPTION_STRING_TABLE, "-units", NULL, NULL,
        "bbox", -1, offsetof(TkPathGradientMaster, linearFill.units),
        0, (ClientData) unitsST, 0},
    {TK_OPTION_CUSTOM, "-stops", NULL, NULL,
	NULL, offsetof(TkPathGradientMaster, stopsObj),
        offsetof(TkPathGradientMaster, linearFill.stopArrPtr),
	TK_OPTION_NULL_OK, (ClientData) &stopsCO, 0},
    {TK_OPTION_CUSTOM, "-lineartransition", NULL, NULL,
	NULL, offsetof(TkPathGradientMaster, transObj),
	offsetof(TkPathGradientMaster, linearFill.transitionPtr),
	TK_OPTION_NULL_OK, (ClientData) &linTransitionCO, 0},
    {TK_OPTION_CUSTOM, "-matrix", NULL, NULL,
	NULL, -1, offsetof(TkPathGradientMaster, matrixPtr),
...
static Tk_OptionSpec radGradientStyleOptionSpecs[] = {
    {TK_OPTION_STRING_TABLE, "-method", NULL, NULL,
        "pad", -1, offsetof(TkPathGradientMaster, radialFill.method),
        0, (ClientData) methodST, 0},
    {TK_OPTION_STRING_TABLE, "-units", NULL, NULL,
        "bbox", -1, offsetof(TkPathGradientMaster, radialFill.units),
        0, (ClientData) unitsST, 0},
    {TK_OPTION_CUSTOM, "-stops", NULL, NULL,
	NULL, offsetof(TkPathGradientMaster, stopsObj),
	offsetof(TkPathGradientMaster, radialFill.stopArrPtr),
	TK_OPTION_NULL_OK, (ClientData) &stopsCO, 0},
    {TK_OPTION_CUSTOM, "-radialtransition", NULL, NULL,
	NULL, offsetof(TkPathGradientMaster, transObj),
        offsetof(TkPathGradientMaster, radialFill.radialPtr),
...
{
    InterpData             *dataPtr =
	(InterpData *) Tcl_GetAssocData(interp, kGradientNameBase, NULL);
	...
	Tcl_SetAssocData(interp, kGradientNameBase,
...
GradientObjCmd(ClientData clientData, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[])
{
    ...
    switch (index) {
		...
		return TCL_ERROR;
            ...
            sprintf(str, "%s%d", kGradientNameBase,
